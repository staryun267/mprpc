...
// source: src/rpcheader.proto

#include "src/rpcheader.pb.h"
...
static ::_pb::Metadata file_level_metadata_src_2frpcheader_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_src_2frpcheader_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_src_2frpcheader_2eproto = nullptr;

const uint32_t TableStruct_src_2frpcheader_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_src_2frpcheader_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\023src/rpcheader.proto\022\005mprpc\"I\n\tRpcHeade"
  "r\022\024\n\014service_name\030\001 \001(\014\022\023\n\013method_name\030\002"
  " \001(\014\022\021\n\targs_size\030\003 \001(\rb\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_src_2frpcheader_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_src_2frpcheader_2eproto = {
    false, false, 111, descriptor_table_protodef_src_2frpcheader_2eproto,
    "src/rpcheader.proto",
    &descriptor_table_src_2frpcheader_2eproto_once, nullptr, 0, 1,
    schemas, file_default_instances, TableStruct_src_2frpcheader_2eproto::offsets,
    file_level_metadata_src_2frpcheader_2eproto, file_level_enum_descriptors_src_2frpcheader_2eproto,
    file_level_service_descriptors_src_2frpcheader_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_src_2frpcheader_2eproto_getter() {
  return &descriptor_table_src_2frpcheader_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_src_2frpcheader_2eproto(&descriptor_table_src_2frpcheader_2eproto);
namespace mprpc {
...
::PROTOBUF_NAMESPACE_ID::Metadata RpcHeader::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_src_2frpcheader_2eproto_getter, &descriptor_table_src_2frpcheader_2eproto_once,
      file_level_metadata_src_2frpcheader_2eproto[0]);
}
